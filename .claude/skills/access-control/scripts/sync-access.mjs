...
//
// Chạy ở GỐC dự án:
//   node .claude/skills/access-control/scripts/sync-access.mjs            # áp dụng
//   node .claude/skills/access-control/scripts/sync-access.mjs --dry-run  # chỉ xem, không đổi gì
//   node .claude/skills/access-control/scripts/sync-access.mjs --prune    # đồng thời XÓA app của trang không còn trong CSV
//
